# Ruh V1: AI-Powered Mental Health Support on Sonic 🧠⛓️
...
<div align="center">
  <img src="https://i.imghippo.com/files/uath6507iKU.png" alt="Ruh V1 Dashboard" width="45%" />
...
1. **Clone & Install**
   ...
   ```bash
   git clone https://github.com/blocklinklabs/ruh-v1.git
   cd ruh-v1
   npm install
   ```
