...
import { SafeNetDashboard } from "@/components/safenet/safenet-dashboard";
...
export default function Dashboard() {
  ...
  const loadActivities = useCallback(async () => {
    ...
    try {
      const userActivities = await getUserActivities(user?._id || "default-user");
  ...
  const fetchDailyStats = useCallback(async () => {
    console.log("fetchDailyStats called");
    try {
    ...
    <div className="min-h-screen bg-background">
      <Container className="pt-20 pb-8 space-y-6">
        ...
        <div className="space-y-6">
          ...
          {/* SafeNet Emergency & Safety Section */}
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <Shield className="h-6 w-6 text-red-600" />
              <h2 className="text-2xl font-bold">SafeNet - Emergency & Safety</h2>
            </div>
            <SafeNetDashboard />
          </div>
